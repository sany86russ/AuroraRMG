...
| **Тип игры** | Расстановка: **Дуэль (1×1)**, **Каждый сам за себя**, **Против монстров (PvE)**, **Дорожки (коридоры)** *(параллельные коридоры со сходом в центральной арене)*, **Командная игра** *(этого режима пока нет в самой игре)*. |
...
| **Охрана границ** | Сила монстров-стражей на проходах между зонами: **Слабая / Обычная / Сильная / Крепость** — «фейс-контроль» против ранних рашей (в расширенном режиме — ползунок «Охрана границ/порталов»). |
...
```
┌──────────────────────────────────────────────────────────────┐
│  🧭 AuroraRMG  [v1.5]  —  имя_файла        🔄 📂 💾 💾…  _ ☐ ✕ │   ← Шапка
├───────────────┬──────────────────────────────┬───────────────┤
│  Правила      │                              │  ⚔ Создать     │
...
| **Дорожки** | Параллельные непересекающиеся коридоры: каждый игрок идёт по своему пути зон **бронза → серебро → золото**, и все коридоры сходятся только в одной центральной спорной «арене» в конце. Игроки встречаются лишь там; охрана на проходах нарастает к центру. В Простом режиме этому соответствует тип игры **«Дорожки (коридоры)»**. |

<img src="https://raw.githubusercontent.com/sany86russ/AuroraRMG/main/docs/ui-simple-lanes.png" alt="Топология «Дорожки»" width="100%"/>
...
- ⚡ **Простой режим / Быстрая генерация** — играбельная случайная карта за пару кликов (+ сид для воспроизводимости и обмена);
...
- 🗺 **большие карты** до **512×512** (сверх официального предела 240×240);
